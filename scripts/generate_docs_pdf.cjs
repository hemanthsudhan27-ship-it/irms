...
const PDFDocument = require(path.resolve(__dirname, '../backend/node_modules/pdfkit'));

const outputPath = path.resolve(__dirname, '../IRMS_Complete_Project_Documentation.pdf');
...
function addSectionTitle(title) {
  doc.moveDown(1);
  doc.fillColor(primaryColor).fontSize(15).font('Helvetica-Bold').text(title);
